      ...
      window.location.href = "/";
        ...
        handler: () => {
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-bilevel-optimization-for-data-cleaning",
          title: 'Bilevel Optimization for Data Cleaning',
          description: "",
          section: "Projects",handler: () => {
              window.location.href = "/projects/data_cleaning/";
            },},{id: "projects-federated-reinforcement-learning",
          ...
          description: "",
          section: "Projects",handler: () => {
              window.location.href = "/projects/uot/";
            },},{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%66%61%72%65%73%65%6C%6B%68%6F%75%72%79%39%38@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/fareselkhoury", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/fares-el-khoury-129876149", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=0onN7GYAAAAJ", "_blank");
        },
      },{
        id: 'social-x',
        title: 'X',
        section: 'Socials',
        handler: () => {
          window.open("https://twitter.com/fares_elkhoury", "_blank");
        },
      },{
        id: 'social-bluesky',
        title: 'Bluesky',
        section: 'Socials',
        handler: () => {
          window.open("https://bsky.app/profile/fareselkhoury.bsky.social", "_blank");
        },
      },{
      id: 'light-theme',
